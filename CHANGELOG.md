...
## 0.1.0
- Features:
  - Added recording feature to roll dialogs.
    - Roll tests are recorded automatically only when checkbox is checked in the roll dialog.
  - Refactored system to implement Stargaze-specific details and folder structure for templates.
- Maintenance:
  - Added localization for roll dialog in the Stargaze module.
- Bigfixes:
  - Fixed BL fate reroll not finding stat fate spent (Merged from upstream master branch).